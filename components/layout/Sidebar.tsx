...
export function Sidebar() {
  ...
  return (
    ...
    `}>
      ...
      <div className="p-4">
        <Link href="/dashboard/chat" className="w-full bg-primary text-on-primary rounded-[8px] py-2 px-4 flex items-center justify-center gap-2 hover:bg-surface-tint transition-colors cursor-pointer active:scale-95 transition-transform">
      ...
      <nav className="flex-1 overflow-y-auto hide-scrollbar py-2">
        <div className="px-2 space-y-1">
          <Link href="/dashboard/chat" className={`flex items-center gap-3 px-4 py-3 rounded-[8px] cursor-pointer transition-all border-l-4 ${isActive('/dashboard/chat') ? 'bg-secondary-container text-on-secondary-container border-primary rounded-r-[8px]' : 'text-on-surface-variant dark:text-outline-variant hover:bg-surface-container-high dark:hover:bg-surface-tint/50 border-transparent hover:border-outline-variant dark:hover:border-outline'}`}>
      ...
      <div className="p-4 border-t border-outline-variant space-y-1">
        ...
        <Link href="/dashboard/profile" className="flex items-center gap-3 px-4 py-2 text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200 rounded-[8px] cursor-pointer active:opacity-80">
        ...
        <button onClick={() => signOut({ callbackUrl: '/login' })} className="w-full flex items-center gap-3 px-4 py-2 text-on-surface-variant hover:bg-surface-container-high transition-colors duration-200 rounded-[8px] cursor-pointer active:opacity-80">
